          ...
          <div className="text-brand-dark leading-relaxed flex flex-col gap-4 lg:gap-5 font-normal">
            ...
            <div className="md:hidden w-full">
              <button
                ...
                className="flex items-center gap-2 text-xs uppercase tracking-wider font-semibold text-brand-dark/60 py-2 cursor-pointer"
              >
              ...
              <motion.div
                ...
                className="overflow-hidden text-sm flex flex-col gap-4 border-b border-brand-dark/5"
